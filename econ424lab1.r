...
plot(sbux.ret$Adj.Close, type="l", col="blue", lwd=2, ylab="Return",
     main="Monthly Simple Returns on SBUX")
abline(h=0)     
# next plot the cc returns
plot(sbux.ccret$Adj.Close, type="l", col="blue", lwd=2, ylab="Return",
...
plot(sbux.fv$Adj.Close, type="l", col="blue", lwd=2, ylab="Dollars", 
